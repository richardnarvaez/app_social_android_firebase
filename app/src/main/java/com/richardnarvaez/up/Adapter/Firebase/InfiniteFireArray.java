...
public class InfiniteFireArray<T> {
    ...
    private String TAG = "InfiniteFireArray";
    ...
    private void addChildEventListenerToQuery(Query query) {
        childEventListener = new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, String previousChild) {
                ...
                boolean lastChild = (dataSnapshots.size() == 0);
                ...
                Log.e(TAG, "DATA: " + dataSnapshots.size() + " " + dataSnapshot.getKey());
                //if(dataSnapshot){}
            ...
            @Override
            public void onChildChanged(@NonNull DataSnapshot dataSnapshot, String previousChild) {
            ...
            @Override
            public void onChildMoved(@NonNull DataSnapshot dataSnapshot, String previousChild) {
                if (fixedItemPositions) {
                    return;
                }
    ...
    private void addValueEventListenerToQuery(Query query) {
        valueEventListener = new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                Log.e(TAG, "DATA: " + childrenCount + "/" + dataSnapshots.size());
