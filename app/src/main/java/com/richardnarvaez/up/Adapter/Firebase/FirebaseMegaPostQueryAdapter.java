...
public class FirebaseMegaPostQueryAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    private int HEADER_ITEM = 100;


    public FirebaseMegaPostQueryAdapter(List<String> paths, int item_home, OnSetupViewListener onSetupViewListener) {
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder, final int position) {
        ...
        Log.d(TAG, "Key Product (" + holder.getAdapterPosition() + ")" + ": " + mPostPaths.get(position));
        ...
        ValueEventListener postListener = new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    mOnSetupViewListener.onSetupUserView(((UserViewHolder) holder), user, position,
                            dataSnapshot.getKey());
                } else {
    ...
    public void onViewRecycled(RecyclerView.ViewHolder holder) {
        ...
        //((PostViewHolder) holder).mPostRef.removeEventListener(((PostViewHolder) holder).mPostListener);
    }
