...
import com.richardnarvaez.up.Activity.PhothoUpload.PickerAdapter;
...
//        mCameraView = v.findViewById(R.id.myGLSurfaceView);
...
//        mCameraView.setZOrderMediaOverlay(true);
        ...
        RecyclerView recyclerView = v.findViewById(R.id.effects);

        final PickerLayoutManager pickerLayoutManager = new PickerLayoutManager(getContext(), PickerLayoutManager.HORIZONTAL, false);
        ...
        PickerAdapter pa = new PickerAdapter(getContext(), getData(), recyclerView);
        ...
        pickerLayoutManager.setOnScrollStopListener(new PickerLayoutManager.onScrollStopListener() {
            ...
            public void selectedView(View view) {
                ...
                if (position >= 0) {
                    //mCameraView.setFilterWithConfig(EFFECT_CONFIGS[position]);
                } else {
                    //mCameraView.setFilterWithConfig(EFFECT_CONFIGS[0]);
                }
                //mCurrentConfig = EFFECT_CONFIGS[2];
...
//        });
    ...
    private List<String> getData() {
        ...
        for (int i = 0; i != EFFECT_CONFIGS.length; ++i) {
            ...
            if (i == 0)
                data.add("None");//, EFFECT_CONFIGS[i]);
            else
                data.add("F." + i);//, EFFECT_CONFIGS[i]);
