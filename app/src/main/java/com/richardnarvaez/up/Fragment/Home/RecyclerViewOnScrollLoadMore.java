...
public class RecyclerViewOnScrollLoadMore extends RecyclerView.OnScrollListener {

    RecyclerViewLoadMore mPullLoadMoreRecyclerView;

    public RecyclerViewOnScrollLoadMore(RecyclerViewLoadMore context) {
        mPullLoadMoreRecyclerView = context;
    }
    ...
    public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
        ...
        if (mPullLoadMoreRecyclerView.getPushRefreshEnable()
            ...
            mPullLoadMoreRecyclerView.loadMore(lastItem);
        }
