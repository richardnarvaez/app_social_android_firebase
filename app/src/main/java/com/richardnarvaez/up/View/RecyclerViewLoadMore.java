package com.richardnarvaez.up.View;
...
public class RecyclerViewLoadMore extends LinearLayout {
    ...
    public RecyclerViewLoadMore(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView(context);
    }
    ...
    private void initView(Context context) {
        ...
        mRecyclerView.addOnScrollListener(new RecyclerViewOnScrollLoadMore(this));
    ...
    public void loadMore(int lastItem) {
...
//                    .start();
            invalidate();
            mPullLoadMoreListener.onLoadMore(lastItem);
        }
    }
...
//                .start();
    ...
    private class SwipeRefreshLayoutOnRefresh implements SwipeRefreshLayout.OnRefreshListener {
        private RecyclerViewLoadMore mPullLoadMoreRecyclerView;

        public SwipeRefreshLayoutOnRefresh(RecyclerViewLoadMore pullLoadMoreRecyclerView) {
